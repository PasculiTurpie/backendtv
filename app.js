...
app.use(cors({
  origin: ['https://signal-operacionestv', 'https://signal-operacionestv/api/v1', 'https:172.19.14.135', 'https:172.19.14.135:5000/api/v1'],  // Reemplázalo por el dominio del frontend
